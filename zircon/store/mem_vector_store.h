...
#ifndef ZIRCON_MEM_STORE_VECTOR_STORE_H_
#define ZIRCON_MEM_STORE_VECTOR_STORE_H_
...
#include "zircon/store/vector_batch.h"
...
namespace zircon {
    ...
    public:
        ...
        turbo::Status initialize(VectorStoreOption op);
...
#endif  // ZIRCON_MEM_STORE_VECTOR_STORE_H_
